    ...
    <head>
        ...
        $(document).ready(function(){
          $("form").submit(function(e){
            alert("You have Confirmed you home, after the admin check in, you will receive a email! Thank You!");
          });
        });
        </script>
    </head>
                    ...
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <p>Please Scan: Left is Alipay, Right is Paypal</p>
                                <img src="images/alipay.png" width="150px" height="150px">
                                <img src="images/paypal.png" width="150px" height="150px">
