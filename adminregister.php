...
if (isset($_POST['signup'])) {
    ...
    if (!$error) {
        if (mysqli_query($con, "INSERT INTO admin(name,email,password) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="adminregister.php"> Admin Registration</a></li>
                    </ul>
                </div>
            </div>
        </nav> 
